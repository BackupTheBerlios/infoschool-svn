 ...
 class person {
  ...
  function person() {
   ...
   $this->optionlist = array( // functions of the bits of one option-byte
     0 => 'classic design',            // classic design
     1 => '',                  // not in use (public e-mail address)
     2 => '',                   // not in use (public icq uin)
     3 => '',                // not in use (use full window, width="100%")
