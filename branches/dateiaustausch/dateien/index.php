...
//�ergibt User und Datum des letzten Dateiuploads im Ordner $ordner_id
...
$string[3] = "<h1>Ordnerübersicht</h1><table border cellpadding=2 cellspacing=2 width=\"100%\" class=\"dateien\">
