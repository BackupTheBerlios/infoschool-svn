...
//�dert den Namen eines Ordners nach $ordnername
...
//L�cht einen Ordner und alle enthaltenen Dateien
...
elseif ($modus == 'besitzer_aendern')
{
	...
	if ($t['art'] == "liste") 
		...
		//Abfrage, um den neuen Besitzer der Datei zu bestimmen - fr die Best�igung
