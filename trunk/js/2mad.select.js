function writeHTML(){
 ...
 document.writeln('<span id="kasten2" class="versteckt"></span>');
}
...
function stop(){
 ...
 with(window.document.getElementById('kasten2').style){
  visibility = 'hidden';
  width = '0px';
  height = '0px';
  backgroundColor = '#000060';
...
function run(t){
 ...
 with(window.document.getElementById('kasten2').style){
  left = 2*get_x0()+get_width()-x-13+2+'px';
  top = 2*get_y0()+get_height()-y-13+2+'px';
 }
 if(t>maxspeed)t--;
